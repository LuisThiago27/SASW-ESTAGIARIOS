...
public class FuncioDAO {
    ...
    /*public void PesquisarFuncio(FuncioDTO objFuncioDTO) throws ClassNotFoundException {

        String sql = "select * from tb_funcionario where Matr = ?";
        ...
        try {
            ...
            pstm.setFloat(15, objFuncioDTO.getHorario());
