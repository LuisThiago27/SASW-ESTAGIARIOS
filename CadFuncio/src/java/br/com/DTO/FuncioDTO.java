...
public class FuncioDTO {
    private String Nome, Nome_Guer, Secao, CCusto, CodPonto, Cargo, Apresen, Situacao, Escala, Funcao, LocalForm,
            Certific, Reg_PF, Local_PF, Reg_PFUF, CarNacVig, CadastroAFIS, Reg_MT, ExtensaoTV, ExtSegPes,
            ExtEscolta, ExtGrdEventos, ExtArmasNLetais, GrupoSang, Instrucao, Raca, EstCivil, Endereco, Numero,
            Complemento, Bairro, Cidade, UF, CEP, Fone1, Fone2, Email, Sexo, Naturalid, Pai, Mae,
            Conjuge, CNH, UF_CNH, Categoria, RG, OrgEmis, CPF, PIS, Reservista, ReservCat, CTPS_Nro, CTPS_Serie,
            CTPS_UF, TitEleit, TitEZona, TitSecao, Ct_Banco, Ct_Agencia, Ct_Conta, Ct_CodOper, Obs, Sindicato,
            DepIR, DepSF, FGTSBanco, FGTSAg, PgCtSin, AssMedic, DepAssMed, CestaBas, ValeRef, ConvFarma, SegVida,
    ...
    public float getCodCargo() {
        return CodCargo;
    }

    public void setCodCargo(float CodCargo) {
    ...
    public float getCHMes() {
        return CHMes;
    }

    public void setCHMes(float CHMes) {
        this.CHMes = CHMes;
    }

    public float getCHSeman() {
        return CHSeman;
    }

    public void setCHSeman(float CHSeman) {
        this.CHSeman = CHSeman;
    }

    public float getHe_Periodo() {
        return He_Periodo;
    }

    public void setHe_Periodo(float He_Periodo) {
        this.He_Periodo = He_Periodo;
    }
    ...
    public float getCodCidade() {
        return CodCidade;
    }

    public void setCodCidade(float CodCidade) {
        this.CodCidade = CodCidade;
    }

    public float getCodNaturalid() {
        return CodNaturalid;
    }

    public void setCodNaturalid(float CodNaturalid) {
        this.CodNaturalid = CodNaturalid;
    }
    ...
    public float getCodPessoaWeb() {
        return CodPessoaWeb;
    }

    public void setCodPessoaWeb(float CodPessoaWeb) {
