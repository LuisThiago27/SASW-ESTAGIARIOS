...
<html>
    ...
    <body>
        ...
        <form action="alterarFuncio.jsp" method="POST">
            ...
            <button onclick="location.href = 'alterarFuncio.jsp'" class="btn btn-primary"> Alterar </button>

        </form>
        <button onclick="location.href = 'listarFuncio.jsp'" class="btn btn-primary"> Voltar </button>
